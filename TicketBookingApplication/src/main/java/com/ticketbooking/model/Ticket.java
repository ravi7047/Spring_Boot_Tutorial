...
@Entity // Table will be created to the database during startup with class name as Table Name
...
public class Ticket {
	...
	@Column(name = "passenger_name") // Customizes the column Name , rather than passengerName, it will passenger_name use 
