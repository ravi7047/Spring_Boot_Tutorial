...
public class HelloResource {
    ...
    //http://localhost:8080/rest/hello/secured/control -> It will be access only for user who is having ADMIN Role
  ...
  //http://localhost:8080/rest/hello/secured/all -> It will be access only for user who is having ADMIN or GUEST Role
